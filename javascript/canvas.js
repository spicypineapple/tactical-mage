...
function toggleAttack() {
  if (mode != "attack") {
    ...
    document.getElementById("selected-unit-spirit-1-action-1").classList.add("selected");
    mode = "attack";
  } else {
    document.getElementById("selected-unit-spirit-1-action-1").classList.remove("selected");
    mode = "default";
  }
}
